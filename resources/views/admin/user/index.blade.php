         ...
         success: function(response){
           ...
           console.log(response);
              ...
              for(var i=0; i<len; i++){
                ...
                var role =role_name;
				  var edit = `<a class="btn btn-info" href="{!!asset('admin/user/edit/` + id + `')!!}">Edit</a>`;
                       createModal({
                        ...
                        var delete_btn = `<a class="btn btn-info" data-toggle="modal" data-target="#` + 'user_' + response['data'][i].id + `">Delete</a>`;
