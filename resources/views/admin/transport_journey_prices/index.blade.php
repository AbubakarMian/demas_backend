		   ...
		   console.log('response2');
              ...
              for(var i=0; i<len; i++){
                ...
                // console.log('ccaaa',response['data'][i].transport_type);
				  ...
				  var edit = `<a class="btn btn-info" href="{!!asset('admin/transport_journey_prices/edit/` + id + `')!!}">Edit</a>`;
                       createModal({
                        ...
                        var delete_btn = `<a class="btn btn-info" data-toggle="modal" data-target="#` + 'transport_journey_prices_' + response['data'][i].id + `">Delete</a>`;
